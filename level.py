...
class Level:
    def __init__(self, level_data, surface):
        ...
        self.enemy_sprites = self.create_tile_group(bg_palm_layout, 'bg palms')
        ...
        for row_index, row in enumerate(layout):
            for col_index, val in enumerate(row):
                if val != '-1':
                    ...
                    if type == 'crates':
                        crate_tile_list = import_cut_graphics('../graphics/decoration//crate.png')
                        grass_surface = crate_tile_list[int(val)]
                        sprite = StaticTile(tile_size, x, y, grass_surface)
                    ...
                    if type == 'fg palms':
                        ...
                        if val == '1':
                            sprite = sprite = Palm(tile_size, x, y, '../graphics/terrain/palm_large', 64)
